...
class Personne
  ...
  def info
    ...
    if en_vie
      "#{nom}, point de vie : #{points_de_vie}/100"
    else
      "#{nom} : Vaincu"
    end
  end
  ...
  def subit_attaque(degats_recus)
    ...
    if points_de_vie <= 0
      ...
      puts "\t#{nom} a perdu #{degats_recus} de point de vie"
    end
  end
end
...
class Joueur < Personne
  ...
  def degats
    ...
    # - Calculer les dégats
    # - Affiche ce qu'il s'est passé
    puts "Le joueur bénéficie de #{degats_bonus} de dégats bonus"
    Random.rand(0..40) + degats_bonus
  end
  ...
  def soin
    ...
    # - Gagner de la vie
    # - Affiche ce qu'il s'est passé
    @points_de_vie += rand(20)
    puts 'Vous avez regagné un peu de vie'
  end
  ...
  def ameliorer_degats
    ...
    # - Affiche ce qu'il s'est passé
    dmg_en_plus = rand(40)
    @degats_bonus += dmg_en_plus
    puts "Les dégats bonus ont été augmenté de #{dmg_en_plus}"
  end
end
...
class Jeu
  ...
  def self.est_fini(joueur, monde)
    ...
    (monde.ennemis_en_vie.size == 0 && joueur.en_vie) || !joueur.en_vie
...
class Monde
  ...
  def ennemis_en_vie
    ...
    ennemis.each do |ennemi|
      ennemis_en_vie_tab << ennemi if ennemi.en_vie
    end
    ennemis_en_vie_tab
  end
end
